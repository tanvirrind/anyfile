  ...
  const comparisonItems = [
    {
      ...
      anyFileX: true,
      anyFileXNote: '<10ms instant format card',
      genericSearch: false,
    ...
    },
    {
      ...
      anyFileX: true,
      anyFileXNote: 'Plain language step-by-step',
      genericSearch: false,
    ...
    },
    {
      ...
      anyFileX: true,
      anyFileXNote: 'Free, open-source & native apps',
      genericSearch: false,
    ...
    },
    {
      ...
      anyFileX: true,
      anyFileXNote: 'Lossless zero-install tools',
      genericSearch: false,
    ...
    },
    {
      ...
      anyFileX: true,
      anyFileXNote: 'Comprehensive recovery steps',
      genericSearch: false,
    ...
    },
    {
      ...
      anyFileX: true,
      anyFileXNote: 'Macro & executable threat rating',
      genericSearch: false,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          <p className="mt-2 text-base text-slate-600 dark:text-slate-400">
            Stop wading through endless ads and sketchy file viewer registry downloads. Open any file in seconds with AnyFileX.
          </p>
        </div>
