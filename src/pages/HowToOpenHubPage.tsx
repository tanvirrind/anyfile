  ...
  return (
    <div className="py-8 md:py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 animate-in fade-in duration-200">
      <SEOHead
        ...
        description="Search and browse step-by-step guides on how to open, view, and troubleshoot 250+ file formats across Windows 11/10, macOS, Linux, iPhone, and Android."
